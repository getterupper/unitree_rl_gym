...
from legged_gym.envs.h1_amp.h1_amp_config import H1AMPCfg, H1AMPCfgPPO
from legged_gym.envs.h1_amp.h1_amp_env import H1AMPRobot
...
task_registry.register("h1_amp", H1AMPRobot, H1AMPCfg(), H1AMPCfgPPO())